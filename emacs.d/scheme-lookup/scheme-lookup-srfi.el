...
(defun scheme-lookup-srfi (symbol-name n &optional anchor)
  (browse-url
   (cond
    ((stringp anchor) 
     (format "file:///opt/plt/share/plt/doc/srfi/srfi-%d.html#%s" n anchor))
    (anchor
     (format "file:///opt/plt/share/plt/doc/srfi/srfi-%d.html#%s" n symbol-name))
    (t
     (format "file:///opt/plt/share/plt/doc/srfi/srfi-%d.html" n)))))
