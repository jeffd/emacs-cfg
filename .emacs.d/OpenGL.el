...
;; to-do list.
;;
;; 1.  make it possible to simply include a template OpenGL file.  It
;;     would really be useful because everytime I start a new homework
;;     assignment, I end up cutting and pasting from old homeworks,
;;     and invariably forget to copy some small but significant stuff.
